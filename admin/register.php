...
<div class="img">
    <img src="./../image/bg-pic2.jpg" width="100%" height="100%" alt="" id="bg-img">
</div>
    ...
    <div class="section " class="px-0">
        ...
        <div class="blur-container py-4 d-flex flex-column justify-content-between">
            ...
            <div class="container text-light d-flex px-4">
                <p class="fs-6 text-intro">Welcome to the administrative online library system. This system tends to help a librarian get access to a varsity number of online books that can be provided online.</p>
            </div>
