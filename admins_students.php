...
<div class="container main-bar p-3">
    ...
    <div class="container pb-2 mt-5 d-flex justify-content-between align-items-center">
    <p class="fa fa-user-friends fa-2x"></p>
    <h2 class="text-center">Admins</h2>
    <a href="" data-bs-toggle="modal" data-bs-target="#adminModal" class="btn btn-outline-dark">Add Admin</a>
</div>
...
<div class="container pb-2 mt-5 d-flex justify-content-between align-items-center">
    <p class="fa fa-users fa-2x"></p>
    <h2 class="text-center">Students</h2>
    <a href="" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-outline-dark">Add Student</a>
</div>
            ...
            <div class="modal-body bg-body-secondary">
                ...
                <form action="./auth/addUser.php" method="post">
                    ...
                    <div class="form-group m-2">
                        ...
                        <select name="status" class="w-100 p-2 border rounded focus-ring focus-ring-success">
